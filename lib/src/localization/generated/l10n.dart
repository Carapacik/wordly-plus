...
class GeneratedLocalizations {
  ...
  String get statistic {
    return Intl.message('Statistics', name: 'statistic', desc: '', args: []);
  }
  ...
  String get initializationFailedDescription {
    return Intl.message(
      'Please try again. Your saved progress has not been deleted.',
      name: 'initializationFailedDescription',
      desc: '',
      args: [],
    );
  }
