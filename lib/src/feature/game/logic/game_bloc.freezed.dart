...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _GameChangeDictionary value)?  changeDictionary,TResult Function( _GameChangeGameMode value)?  changeGameMode,TResult Function( _GameResetBoard value)?  resetBoard,TResult Function( _GameLetterPressed value)?  letterPressed,TResult Function( _GameDeletePressed value)?  deletePressed,TResult Function( _GameDeleteLongPressed value)?  deleteLongPressed,TResult Function( _GameRefreshDaily value)?  refreshDaily,TResult Function( _GameEnterPressed value)?  enterPressed,TResult Function( _GameRetryLevelPersistence value)?  retryLevelPersistence,TResult Function( _GameListenKeyEvent value)?  listenKeyEvent,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return deleteLongPressed(_that);case _GameRefreshDaily() when refreshDaily != null:
return refreshDaily(_that);case _GameEnterPressed() when enterPressed != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _GameChangeDictionary value)  changeDictionary,required TResult Function( _GameChangeGameMode value)  changeGameMode,required TResult Function( _GameResetBoard value)  resetBoard,required TResult Function( _GameLetterPressed value)  letterPressed,required TResult Function( _GameDeletePressed value)  deletePressed,required TResult Function( _GameDeleteLongPressed value)  deleteLongPressed,required TResult Function( _GameRefreshDaily value)  refreshDaily,required TResult Function( _GameEnterPressed value)  enterPressed,required TResult Function( _GameRetryLevelPersistence value)  retryLevelPersistence,required TResult Function( _GameListenKeyEvent value)  listenKeyEvent,}){
final _that = this;
switch (_that) {
...
return deleteLongPressed(_that);case _GameRefreshDaily():
return refreshDaily(_that);case _GameEnterPressed():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _GameChangeDictionary value)?  changeDictionary,TResult? Function( _GameChangeGameMode value)?  changeGameMode,TResult? Function( _GameResetBoard value)?  resetBoard,TResult? Function( _GameLetterPressed value)?  letterPressed,TResult? Function( _GameDeletePressed value)?  deletePressed,TResult? Function( _GameDeleteLongPressed value)?  deleteLongPressed,TResult? Function( _GameRefreshDaily value)?  refreshDaily,TResult? Function( _GameEnterPressed value)?  enterPressed,TResult? Function( _GameRetryLevelPersistence value)?  retryLevelPersistence,TResult? Function( _GameListenKeyEvent value)?  listenKeyEvent,}){
final _that = this;
switch (_that) {
case _GameChangeDictionary() when changeDictionary != null:
return changeDictionary(_that);case _GameChangeGameMode() when changeGameMode != null:
...
class _GameRefreshDaily implements GameEvent {
  const _GameRefreshDaily();
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _GameRefreshDaily);
}
